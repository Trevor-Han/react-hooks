  ...
  const items: MenuItem[] = [
    {
      ...
      label: <NavLink to='/dashboard'>
        <span className='icon' style={{ background: page === 'dashboard' ? color : '' }}>{dashboard}</span>
    ...
    },
    {
      ...
      label: <NavLink to='/tables'>
        <span className='icon' style={{ background: page === 'tables' ? color : '' }}>{tables}</span>
    ...
    },
    {
      ...
      label: <NavLink to='/billing'>
        <span className='icon' style={{ background: page === 'billing' ? color : '' }}>{billing}</span>
    ...
    },
    {
      ...
      label: <NavLink to='/rtl'>
        <span className='icon' style={{ background: page === 'rtl' ? color : '' }}>{rtl}</span>
    ...
    // },
    {
      ...
      label: <NavLink to='/profile'>
        <span className='icon' style={{ background: page === 'profile' ? color : '' }}>{profile}</span>
