...
// import themeStore from '@/store/festures/theme.ts'
//
...
import { HeaderState } from '@/components/layout/HeaderState.ts'
        ...
        <Col span={24} md={18} className='header-control'>
          <Badge size='small' count={4}>
            <Dropdown menu={{ items }} trigger={['click']}>
              <a href=' ' className='ant-dropdown-link' onClick={(e) => e.preventDefault()}>{bell}</a>
            </Dropdown>
          </Badge>
