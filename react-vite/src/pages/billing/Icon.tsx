...
const data = [
  { title: 'March, 01, 2021', description: '#MS-415646', amount: '$180', id: '123_1' },
  { title: 'February, 12, 2021', description: '#RV-126749', amount: '$250', id: '123_2' },
  { title: 'April, 05, 2020', description: '#FB-212562', amount: '$550', id: '123_3' },
  { title: 'June, 25, 2019', description: '#QW-103578', amount: '$400', id: '123_4' },
  { title: 'March, 03, 2019', description: '#AR-803481', amount: '$700', id: '123_5' }
]
...
const information = [
  { title: 'Oliver Liam', name: 'Viking Burrito', address: 'oliver@burrito.com', vat: 'FRB1235476', id: '12' },
  { title: 'Lucas Harper', name: 'Stone Tech Zone', address: 'lucas@syone-tech.com', vat: 'FRB12354', id: '123' },
  { title: 'Oliver Liam', name: 'ethan@fiber.com', vat: 'NumberFRB1235476', id: '124' }
]
const calender = [
  <svg
    width='18'
...
export { data, wifi, angle, pencil, download, deletebtn, information, calender, newest, yesterday }
