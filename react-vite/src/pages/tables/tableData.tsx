...
const columns = [
  { title: 'AUTHOR', dataIndex: 'name', key: 'name', width: '32%' },
  { title: 'FUNCTION', dataIndex: 'function', key: 'function' },
  { title: 'STATUS', key: 'status', dataIndex: 'status' },
  { title: 'EMPLOYED', key: 'employed', dataIndex: 'employed' }
]
...
const project = [
  { title: 'COMPANIES', dataIndex: 'name', width: '32%' },
  { title: 'BUDGET', dataIndex: 'age' },
  { title: 'STATUS', dataIndex: 'address' },
...
export { columns, project, data, dataProject }
